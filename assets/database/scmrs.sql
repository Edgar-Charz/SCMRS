...
INSERT INTO `colleges` (`college_id`, `college_name`, `college_shortcode`, `created_at`) VALUES
(1, 'College of Engineering and Technology', 'COET', '2026-05-10 12:43:57'),
(2, 'College of Natural and Applied Sciences', 'CONAS', '2026-05-10 12:43:57'),
(3, 'College of Social Sciences', 'CoSS', '2026-05-10 12:43:57'),
(4, 'College of Humanities', 'CoHU', '2026-05-10 12:43:57'),
(5, 'College of Information and Communication Technologies', 'CoICT', '2026-05-10 12:43:57'),
(6, 'College of Agricultural Sciences and Fisheries Technology', 'CoAF', '2026-05-10 12:43:57'),
(7, 'School of Education', 'SoE', '2026-05-10 12:43:57'),
(8, 'School of Law', 'SoL', '2026-05-10 12:43:57'),
(9, 'School of Journalism and Mass Communication', 'SJMC', '2026-05-10 12:43:57');
...
CREATE TABLE `complaints` (
  ...
  `complaint_status` enum('pending','in_progress','rejected','awaiting_student_response','resolved') DEFAULT 'pending',
...
INSERT INTO `complaint_categories` (`category_id`, `category_name`, `category_description`, `requires_department_selection`, `auto_assign_department_id`, `created_by`, `status`, `created_at`) VALUES
(1, 'Academic Affairs', 'Complaints related to academic activities, examinations, and coursework', 1, NULL, 1, 'active', '2026-05-10 12:43:57'),
(2, 'Financial Services', 'Complaints related to fees, bursaries, loans, and financial transactions', 0, 30, 1, 'active', '2026-05-10 12:43:57'),
(3, 'Accommodation and Housing', 'Complaints related to hostels, room allocation, and campus housing', 0, 34, 1, 'active', '2026-05-10 12:43:57'),
(4, 'Student Services', 'Complaints related to student welfare, health, ID cards, and general services', 0, 33, 1, 'active', '2026-05-10 12:43:57'),
(5, 'Staff Conduct', 'Complaints about staff behaviour, misconduct, or professional ethics', 1, NULL, 1, 'active', '2026-05-10 12:43:57'),
(6, 'ICT and Internet Services', 'Complaints about internet, university systems, email, and digital tools', 0, 32, 1, 'active', '2026-05-10 12:43:57'),
(7, 'Infrastructure and Facilities', 'Complaints about classrooms, laboratories, toilets, and physical facilities', 0, 34, 1, 'active', '2026-05-10 12:43:57'),
(8, 'Library Services', 'Complaints related to library access, books, and study resources', 0, 33, 1, 'active', '2026-05-10 12:43:57');
...
CREATE TABLE `complaint_messages` (
  ...
  `message_type` enum('normal','collabo_note','request_info','feedback') DEFAULT 'normal',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `complaint_subcategories` (`subcategory_id`, `category_id`, `subcategory_name`, `subcategory_description`, `status`, `created_by`, `created_at`) VALUES
(1, 1, 'Examination Issues', 'Problems related to sitting or accessing examinations', 'active', 1, '2026-05-10 12:43:57'),
(2, 1, 'Course Registration Problems', 'Difficulty registering for courses or units', 'active', 1, '2026-05-10 12:43:57'),
(3, 1, 'Grade and Mark Appeals', 'Dispute over assigned marks or final grades', 'active', 1, '2026-05-10 12:43:57'),
(4, 1, 'Academic Transcripts', 'Requests or issues with official transcripts and certificates', 'active', 1, '2026-05-10 12:43:57'),
(5, 1, 'Missing or Incorrect Marks', 'Marks not recorded or incorrectly entered in the system', 'active', 1, '2026-05-10 12:43:57'),
(6, 1, 'Supplementary Exam Issues', 'Problems related to supplementary or special examinations', 'active', 1, '2026-05-10 12:43:57'),
(7, 2, 'Bursary and Scholarship Issues', 'Problems receiving or applying for bursaries and scholarships', 'active', 1, '2026-05-10 12:43:57'),
(8, 2, 'Fee Payment Problems', 'Difficulties with fee payment, receipts, or bank transfers', 'active', 1, '2026-05-10 12:43:57'),
(9, 2, 'Student Loan Complaints', 'Issues with HESLB loans and disbursements', 'active', 1, '2026-05-10 12:43:57'),
(10, 2, 'Refund Requests', 'Requesting refunds for overpaid or unclaimed fees', 'active', 1, '2026-05-10 12:43:57'),
(11, 2, 'Incorrect Fee Charges', 'Charged fees that do not match the official fee structure', 'active', 1, '2026-05-10 12:43:57'),
(12, 3, 'Hostel Allocation Issues', 'Problems with hostel room assignment or allocation', 'active', 1, '2026-05-10 12:43:57'),
(13, 3, 'Room Maintenance and Repairs', 'Maintenance issues in hostel rooms or common areas', 'active', 1, '2026-05-10 12:43:57'),
(14, 3, 'Hostel Security Concerns', 'Safety and security problems within hostel premises', 'active', 1, '2026-05-10 12:43:57'),
(15, 3, 'Water and Electricity Problems', 'Utility supply issues in hostels', 'active', 1, '2026-05-10 12:43:57'),
(16, 3, 'Hostel Fee Disputes', 'Disagreements over hostel charges and billing', 'active', 1, '2026-05-10 12:43:57'),
(17, 4, 'Student ID Card Issues', 'Lost, damaged, or delayed student identification cards', 'active', 1, '2026-05-10 12:43:57'),
(18, 4, 'Health Centre Complaints', 'Issues with medical services at the university health centre', 'active', 1, '2026-05-10 12:43:57'),
(19, 4, 'Transportation Issues', 'Problems with university bus services or transport schedules', 'active', 1, '2026-05-10 12:43:57'),
(20, 4, 'Sports and Recreation', 'Access or quality of sports and recreational facilities', 'active', 1, '2026-05-10 12:43:57'),
(21, 4, 'Student Organisation Issues', 'Complaints relating to student government or clubs', 'active', 1, '2026-05-10 12:43:57'),
(22, 5, 'Lecturer Misconduct', 'Unprofessional behaviour by a teaching staff member', 'active', 1, '2026-05-10 12:43:57'),
(23, 5, 'Harassment or Discrimination', 'Any form of harassment or discriminatory treatment', 'active', 1, '2026-05-10 12:43:57'),
(24, 5, 'Unfair Assessment', 'Perceived unfair marking or biased assessment by staff', 'active', 1, '2026-05-10 12:43:57'),
(25, 5, 'Academic Dishonesty Allegations', 'Accusations of plagiarism, cheating, or exam misconduct', 'active', 1, '2026-05-10 12:43:57'),
(26, 6, 'Internet Connectivity Issues', 'Slow, unstable, or no internet access on campus', 'active', 1, '2026-05-10 12:43:57'),
(27, 6, 'University Email Problems', 'Issues accessing or using the official university email', 'active', 1, '2026-05-10 12:43:57'),
(28, 6, 'Student Portal Issues', 'Problems with the online student portal or e-learning system', 'active', 1, '2026-05-10 12:43:57'),
(29, 6, 'Software and System Access', 'Inability to access university licensed software or systems', 'active', 1, '2026-05-10 12:43:57'),
(30, 7, 'Classroom Condition', 'Poor state of lecture rooms, desks, or seating', 'active', 1, '2026-05-10 12:43:57'),
(31, 7, 'Laboratory Equipment Issues', 'Missing, broken, or insufficient laboratory equipment', 'active', 1, '2026-05-10 12:43:57'),
(32, 7, 'Sanitation and Toilets', 'Dirty or non-functional toilet facilities on campus', 'active', 1, '2026-05-10 12:43:57'),
(33, 7, 'Lecture Hall Overcrowding', 'Insufficient space or seats for enrolled students', 'active', 1, '2026-05-10 12:43:57'),
(34, 8, 'Book Availability', 'Required books or resources not available in the library', 'active', 1, '2026-05-10 12:43:57'),
(35, 8, 'Library Access Issues', 'Denied or restricted access to library facilities', 'active', 1, '2026-05-10 12:43:57'),
(36, 8, 'E-Library and Online Resources', 'Problems accessing digital journals, databases, or e-books', 'active', 1, '2026-05-10 12:43:57'),
(37, 8, 'Study Space Concerns', 'Insufficient or poorly maintained study areas in the library', 'active', 1, '2026-05-10 12:43:57');
...
INSERT INTO `departments` (`department_id`, `department_college_id`, `department_name`, `created_at`) VALUES
(1, 1, 'Civil Engineering', '2026-05-10 12:43:57'),
(2, 1, 'Electrical Engineering', '2026-05-10 12:43:57'),
(3, 1, 'Mechanical and Industrial Engineering', '2026-05-10 12:43:57'),
(4, 1, 'Chemical and Mining Engineering', '2026-05-10 12:43:57'),
(5, 2, 'Physics', '2026-05-10 12:43:57'),
(6, 2, 'Chemistry', '2026-05-10 12:43:57'),
(7, 2, 'Mathematics', '2026-05-10 12:43:57'),
(8, 2, 'Zoology and Wildlife Conservation', '2026-05-10 12:43:57'),
(9, 2, 'Botany', '2026-05-10 12:43:57'),
(10, 3, 'Sociology and Social Anthropology', '2026-05-10 12:43:57'),
(11, 3, 'Political Science and Public Administration', '2026-05-10 12:43:57'),
...
(16, 4, 'Philosophy and Religious Studies', '2026-05-10 12:43:57'),
(17, 4, 'Foreign Languages and Linguistics', '2026-05-10 12:43:57'),
(18, 5, 'Computer Science and Engineering', '2026-05-10 12:43:57'),
(19, 5, 'Information Systems', '2026-05-10 12:43:57'),
(20, 5, 'Electronics and Telecommunications', '2026-05-10 12:43:57'),
(21, 6, 'Crop Science and Horticulture', '2026-05-10 12:43:57'),
(22, 6, 'Animal Science and Production', '2026-05-10 12:43:57'),
(23, 6, 'Food Technology', '2026-05-10 12:43:57'),
(24, 7, 'Educational Psychology and Curriculum Studies', '2026-05-10 12:43:57'),
(25, 7, 'Educational Foundations and Administration', '2026-05-10 12:43:57'),
(26, 8, 'Public Law', '2026-05-10 12:43:57'),
(27, 8, 'Private Law', '2026-05-10 12:43:57'),
(28, 9, 'Journalism', '2026-05-10 12:43:57'),
(29, 9, 'Mass Communication', '2026-05-10 12:43:57'),
(30, NULL, 'Finance and Accounts Office', '2026-05-10 12:43:57'),
(31, NULL, 'Registrar\'s Office', '2026-05-10 12:43:57'),
(32, NULL, 'ICT Directorate', '2026-05-10 12:43:57'),
(33, NULL, 'Student Services Office', '2026-05-10 12:43:57'),
(34, NULL, 'Estates and Works Department', '2026-05-10 12:43:57'),
(35, NULL, 'Human Resources Office', '2026-05-10 12:43:57');
...
CREATE TABLE `notifications` (
  ...
  `type` enum('status_change','new_assignment','request_info') NOT NULL,
...
INSERT INTO `staff_roles` (`role_id`, `role_name`, `role_rank`, `created_at`) VALUES
...
INSERT INTO `users` (`user_id`, `username`, `user_email`, `user_phone_number`, `user_password`, `user_role`, `user_status`, `created_at`, `failed_attempts`, `account_locked`, `lock_time`) VALUES
(1, 'Admin', 'admin@udsm.ac.tz', '0700000000', '$2y$10$GJbJ23NJk0eaZtxLEpa3FOrRo6rCywXUWV84gYmCyGYYKcLdOr2hu', 'admin', 'active', '2026-05-10 12:43:57', 0, 0, NULL);
...
--
ALTER TABLE `complaint_messages`
  ADD CONSTRAINT `complaint_messages_ibfk_1` FOREIGN KEY (`complaint_id`) REFERENCES `complaints` (`complaint_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `complaint_messages_ibfk_2` FOREIGN KEY (`sender_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
